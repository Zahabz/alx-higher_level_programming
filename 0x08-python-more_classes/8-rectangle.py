...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Compares the areas of two Rectangle objects and returns the object with the larger area and also checks if they are class instances 

        Args:
        -----
          - rect_1(object): First Rectangle
          - rect_2(object): Other Rectangle

        Returns:
          - rect_1 if area is of the same value else the rectangle object with the larger area
        """
